            ...
            <form action="" id="update" class="lg-grid register_form client_register">
                <div class="profile g-12 lg-grid" style="flex-direction: column;gap: 0px;">
                    <div class="form-group g-12 photo_group">
                        ...
                        <label for="photo">
                            <img id="preview"
                                src="/imgs/doctor/uploads/therapist_profile/{{ $therapist->photo ? $therapist->photo : 'default_client_profile.jpg' }}"
                                alt="">
                            <div class="after">
                ...
                <div class="form-group g-6">
                    <input type="text" name="first_name" id="first_name" value="{{ $therapist->first_name }}"
                        class="form-control" placeholder="First name *">
                </div>
                <div class="form-group g-6">
                    <input type="text" name="last_name" id="last_name" class="form-control"
                        value="{{ $therapist->last_name }}" placeholder="Last name *">
                </div>
                <div class="form-group g-6">
                    <input type="email" name="email" id="email" class="form-control"
                        value="{{ $therapist->email }}" placeholder="Email *">
                </div>
                <div class="form-group g-6 lg-grid">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control g-7"
                        value="{{ $therapist->phone }}" placeholder="Phone number *">
                </div>
                <div class="form-group g-12">
                    <input type="hidden" name="address_lat" id="address_lat">
                    <input type="hidden" name="address_lng" id="address_lng">
                    <input type="hidden" name="address" id="address">
                    <a href="" id="address-a">{{ $therapist->address }}</a>
                </div>
                <div class="form-group g-6">
