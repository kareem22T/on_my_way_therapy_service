                                    ...
                                    @foreach ($days as $day)
                                        <td>
                                            ...
                                            <input type="text" class="start form-control"
                                                ...
                                                value="{{ DB::table('workingHours')->where('day_of_week', $day)->where('doctor_id', Auth::guard('doctor')->user()->id)->first() == null? '': DB::table('workingHours')->where('day_of_week', $day)->where('doctor_id', Auth::guard('doctor')->user()->id)->first()->start_time }}">

                                            <input type="text" class="end form-control" name="{{ $day }}_end"
                                                placeholder="End work" onfocus="(this.type='time')"
                                                onblur="(this.type='text')"
                                                value="{{ DB::table('workingHours')->where('day_of_week', $day)->where('doctor_id', Auth::guard('doctor')->user()->id)->first() == null? '': DB::table('workingHours')->where('day_of_week', $day)->where('doctor_id', Auth::guard('doctor')->user()->id)->first()->end_time }}">
                                        </td>
                                    @endforeach
                                </tr>
                            </tbody>
