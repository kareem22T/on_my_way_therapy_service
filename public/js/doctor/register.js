// to get if there registered doctor
let thereDoctor;
fetch("/doctor/there-doctor")
...
// form for step one of registration process
let select = ('\
<select name="countryCode" id="" class="form-control g-4">\
...
// check if there a regitered doctor or not and at any step he stop to complete the registration
if (thereDoctor) 
{

} else {
    document.getElementById('register_root').innerHTML = step1;
}
// end ...
